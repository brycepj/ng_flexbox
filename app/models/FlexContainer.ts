// this is where we add methods (non UI related to a flexContainer list)
// They will need to be triggered in the UI, but validation and everything can happen here
...
export class FlexContainer {
	...
	createItem() {
		// TODO: No need for a factory yet -- maybe when cfg gets more complex
		var newItem = new FlexItem('cfg');
	...
	// might be a good idea to break this into another file
}
