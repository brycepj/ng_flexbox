...
@Component({
	selector: 'flex-item',
	template: `
	  <div [ngStyle]="setStyles()" class="flex-item animated">
      ...
      <div class="fi-options" *ngIf="viewSettings">
        <span class="fi-o-title">
          <a href="#" (click)="makeFixedWidth" [ngStyle]="{fontSize:highlightFixed}">fixed</a> or
          <a href="#" (click)="makeFlexyWidth" [ngStyle]="{fontSize:highlightFlexy}">flexy</a> width?
        </span>
